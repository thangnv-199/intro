const bannerSlider1List = document.querySelector('.banner-slider .slider-list');
const bannerSlider2List = document.querySelector('.mall-slider .slider-list');
...
const generate = {
    ...
    generateFeature: function(data, container) {
    ...
    generateDirectory: function(data, container) {
    ...
    generateSuperSale: function(data, container) {
    ...
    generateFlashSale: function(data, container) {
    ...
    generateMallDirectory: function(data, container) {
    ...
    generateSearchTrending: function(data, container) {
    ...
    generateTopTrending: function(data, container) {
        data.sort(() => 0.5 - Math.random());
    ...
    generateSuggestions: function(data, container) {
        data.sort(() => 0.5 - Math.random());
    ...
    generateBanner: function (data, container) {
    ...
    start: function() {
        this.init();
        this.generateFeature(this.featureData, featureList);
        this.generateDirectory(this.directoryData, directoryList);
        this.generateSuperSale(this.superSaleData, superSaleList);
        this.generateFlashSale(this.flashSaleData, flashSaleList);
        this.generateMallDirectory(this.mallDirectoryData, mallDirectoryList);
        this.generateSearchTrending(this.searchTrendingData, searchTrendingList);
        this.generateTopTrending(this.searchTopData, searchTopList);
        this.generateSuggestions(this.suggestionsData, suggestionsList);
        this.generateBanner(this.bannerSlider1Data, bannerSlider1List);
        this.generateBanner(this.bannerSlider2Data, bannerSlider2List);
    },
}
